...
$rows = sathi_users_list_by_status('approved', 200);
?>
      ...
      <table class="admin-table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><?php echo htmlspecialchars((string) ($r['religion_name'] ?? '—'), ENT_QUOTES, 'UTF-8'); ?></td>
            <td><?php echo htmlspecialchars(substr((string) ($r['created_at'] ?? ''), 0, 10), ENT_QUOTES, 'UTF-8'); ?></td>
            <td><a class="admin-btn admin-btn-secondary admin-btn-sm" href="member-view.php?id=<?php echo (int) ($r['id'] ?? 0); ?>">View</a></td>
          </tr>
          <?php endforeach; ?>
          <?php endif; ?>
        </tbody>
